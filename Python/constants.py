...
class Wire:
	...
	STAND_WIRE_OUT_CON = [RFIFO_OUT_WIRE, RFIFO_WR_COUNT_WIRE, RFIFO_RD_COUNT_WIRE, AT_DATA_WIRE_CHECK, SIGNAL_WIRE_CHECK, STATE]

	CURR_WIRE_OUT_CON = STAND_WIRE_OUT_CON + [DS_CHECK, RC_CHECK]
